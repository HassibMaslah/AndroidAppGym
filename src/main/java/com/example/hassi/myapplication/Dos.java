...
public class Dos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager =(ViewPager) findViewById(R.id.viewPagerDos);
        sliderDotsPanel=(LinearLayout) findViewById(R.id.SliderDotsDos);

        ViewPagerAdapterDos viewPagerAdapterDos=new ViewPagerAdapterDos(this);
        viewPager.setAdapter(viewPagerAdapterDos);

        dotsCount=viewPagerAdapterDos.getCount();
