...
public class Biceps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager =(ViewPager) findViewById(R.id.viewPagerBi);
        sliderDotsPanel=(LinearLayout) findViewById(R.id.SliderDotsBi);

        ViewPagerAdapterBi viewPagerAdapterBi=new ViewPagerAdapterBi(this);
        viewPager.setAdapter(viewPagerAdapterBi);

        dotsCount=viewPagerAdapterBi.getCount();
